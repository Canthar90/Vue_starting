  ...
  <li class="mb-7">
    ...
    >
      <div class="mx-8 border-b border-solid border-brand-gray-2 pb-2 pt-5">
        <h2 class="mb-2 text-2xl">Technical Program Manager, Percepion</h2>
      ...
      <div class="px-8 py-4">
        <div>
          ...
          <div>
            <ul class="list-disc pl-8">
              <li>Batchelor's degree or equivalent practical experience.</li>
        ...
        <div class="mt-2 text-center">
          <router-link to="/jobs/reasults/1" class="text-brand-blue-1">Expand</router-link>
        </div>
      </div>
    </router-link>
  </li>
